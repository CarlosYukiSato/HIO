...
iterations = 10000
filtercount = 10	# Number of filters to apply. Set to 1 for HIO-only.
...
def CallOSS(HDR_FILE_PATH, SAVE_FILES_PATH, Seed):
	...
	errorkspace = gpuarray.zeros(k_space.shape, np.float32) 
	...
	while (iter < iterations):
		...
		if iter % 100 == 0:
			printw('Filter: ' + str(int(lastUsedSigma)) + '   Iteration: ' + str(iter) + '   ')
